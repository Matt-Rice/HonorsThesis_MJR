...
models = ["./models/env_0/model_steps_100000.zip", "./models/env_1/model_steps_100000.zip", "./models/env_2/model_steps_100000.zip", "./models/env_3/model_steps_100000.zip"]
...
def main():
    for env, model, output_dir, name in zip(train_envs, models, output_dirs, names):
