...
#         # Euclidean distance
#         return math.sqrt((self.start.x - s.x) ** 2 + (self.start.y - s.y) ** 2)
...
#         last = self.start
#         planning_time = self.compute_shortest_path()
...
#                         plt.pause(pause_time)
#         print("Path found")
#         return True, pathx, pathy, planning_time
...
#     # set boundary obstacle positions
...
#     #Medium Reroute
#     # spoofed_ox = [[], [], [], [40 for _ in range(10, 21)], [], [], [], [i for i in range(40, 58)]]
#     # spoofed_oy = [[], [], [], [i for i in range(10, 21)], [], [], [], [45 for _ in range(40, 58)]]

#     # # Obstacles that demonstrate large rerouting
#     # spoofed_ox = [[], [i for i in range(0, 21)], [],
#     #               [20 for _ in range(40, 55)], [i for i in range(20, 35)], [], [40 for _ in range(10, 21)], [],
#     #               [],  [], [i for i in range(40, 58)]]
#     # spoofed_oy = [[], [6 for _ in range(0, 21)], [],
#     #               [i for i in range(40, 55)], [54 for _ in range(20, 35)], [], [i for i in range(10, 21)], [],
#     #               [], [], [42 for _ in range(40, 58)]]

#     if show_animation:
#         dstarlite = DStarLite(ox, oy)
#         found, path_x, path_y, planning_time = dstarlite.main(Node(x=sx, y=sy), Node(x=gx, y=gy), spoofed_ox=spoofed_ox,
#                                                               spoofed_oy=spoofed_oy)
#         print(f"Found: {found}\n"
#               f"Start Coordinates: ({sx},{sy})\n"
#               f"Goal Coordinates: ({gx},{gy})\n"
#               f"Path Length: {len(path_x)}\n"
#               f"Path Planning time: {planning_time}")
#         plt.show()
#     else:
#         planning = []
#         for i in range(0, 5):
#             dstarlite = DStarLite(ox, oy)
#             found, path_x, path_y, planning_time = dstarlite.main(Node(x=sx, y=sy), Node(x=gx, y=gy),
#                                                                   spoofed_ox=spoofed_ox, spoofed_oy=spoofed_oy)
#             # Get a list of the planning time
#             planning.append(planning_time)
...
#         # Print average path planning time
#         print(f"Average Path Planning time: {numpy.average(planning)}")
